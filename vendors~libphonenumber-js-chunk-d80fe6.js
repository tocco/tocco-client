...
var ELIGIBLE_FORMAT_PATTERN = new RegExp('^' + '[' + _common__WEBPACK_IMPORTED_MODULE_2__["VALID_PUNCTUATION"] + ']*' + '(\\$\\d[' + _common__WEBPACK_IMPORTED_MODULE_2__["VALID_PUNCTUATION"] + ']*)+' + '$');
...
var VALID_INCOMPLETE_PHONE_NUMBER = '[' + _common__WEBPACK_IMPORTED_MODULE_2__["PLUS_CHARS"] + ']{0,1}' + '[' + _common__WEBPACK_IMPORTED_MODULE_2__["VALID_PUNCTUATION"] + _common__WEBPACK_IMPORTED_MODULE_2__["VALID_DIGITS"] + ']*';
  ...
  */
	...
	_createClass(AsYouType, [{
		...
		value: function input(text) {
			...
			var extracted_number = Object(_parse__WEBPACK_IMPORTED_MODULE_3__["extract_formatted_phone_number"])(text) || '';
			...
			return this.process_input(Object(_parseIncompletePhoneNumber__WEBPACK_IMPORTED_MODULE_6__["default"])(extracted_number));
		}
	}, {
		key: 'process_input',
		...
		value: function attempt_to_format_complete_phone_number() {
			for (var _iterator = this.matching_formats, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
				...
				var formatted_number = Object(_format__WEBPACK_IMPORTED_MODULE_4__["format_national_number_using_format"])(this.national_number, format, this.is_international(), this.national_prefix !== '', this.metadata);
		...
		value: function extract_country_calling_code() {
			var _extractCountryCallin = Object(_common__WEBPACK_IMPORTED_MODULE_2__["extractCountryCallingCode"])(this.parsed_input, this.default_country, this.metadata.metadata),
		...
		value: function extract_national_prefix() {
			...
			var _strip_national_prefi = Object(_parse__WEBPACK_IMPORTED_MODULE_3__["strip_national_prefix_and_carrier_code"])(this.national_number, this.metadata),
			...
			if (!this.metadata.possibleLengths() || this.is_possible_number(this.national_number) && !this.is_possible_number(potential_national_number)) {
				...
				if (Object(_common__WEBPACK_IMPORTED_MODULE_2__["matches_entirely"])(this.national_number, this.metadata.nationalNumberPattern()) && !Object(_common__WEBPACK_IMPORTED_MODULE_2__["matches_entirely"])(potential_national_number, this.metadata.nationalNumberPattern())) {
					return;
				}
			}
		...
		value: function is_possible_number(number) {
			var validation_result = Object(_getNumberType__WEBPACK_IMPORTED_MODULE_5__["check_number_length_for_type"])(number, undefined, this.metadata);
		...
		value: function get_format_format(format) {
			if (this.is_international()) {
				return Object(_format__WEBPACK_IMPORTED_MODULE_4__["changeInternationalFormatStyle"])(format.internationalFormat());
			}
		...
		value: function determine_the_country() {
			this.country = Object(_parse__WEBPACK_IMPORTED_MODULE_3__["find_country_code"])(this.countryCallingCode, this.national_number, this.metadata);
		}
	}, {
		key: 'getNumber',
...
var PhoneNumber = function () {
	...
	_createClass(PhoneNumber, [{
		...
		value: function isPossible() {
			return Object(_isPossibleNumber__WEBPACK_IMPORTED_MODULE_1__["default"])(this, { v2: true }, this.metadata);
		}
	}, {
		key: 'isValid',
		value: function isValid() {
			return Object(_validate__WEBPACK_IMPORTED_MODULE_2__["default"])(this, { v2: true }, this.metadata);
		}
	}, {
		key: 'getType',
		value: function getType() {
			return Object(_getNumberType__WEBPACK_IMPORTED_MODULE_3__["default"])(this, { v2: true }, this.metadata);
		}
	}, {
		key: 'format',
		value: function format(_format, options) {
			return Object(_format__WEBPACK_IMPORTED_MODULE_4__["default"])(this, _format, options ? _extends({}, options, { v2: true }) : { v2: true }, this.metadata);
		}
	}, {
		key: 'formatNational',
...
'(?:' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pZ"] + '-|-' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pZ"] + ')' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pZ"] + '*(.+)',

// Various types of wide hyphens. Note we have decided not to enforce a space here, since it's
// possible that it's supposed to be used to break two numbers without spaces, and we haven't
// seen many instances of it used within a number.
'[\u2012-\u2015\uFF0D]' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pZ"] + '*(.+)',

// Breaks on a full stop - e.g. "12345. 332-445-1234 is my number."
'\\.+' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pZ"] + '*([^.]+)',

// Breaks on space - e.g. "3324451234 8002341234"
_findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pZ"] + '+(' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["PZ"] + '+)'];

// Limit on the number of leading (plus) characters.
var leadLimit = Object(_findNumbers_util__WEBPACK_IMPORTED_MODULE_2__["limit"])(0, 2);

// Limit on the number of consecutive punctuation characters.
var punctuationLimit = Object(_findNumbers_util__WEBPACK_IMPORTED_MODULE_2__["limit"])(0, 4);

/* The maximum number of digits allowed in a digit-separated block. As we allow all digits in a
 * single block, set high enough to accommodate the entire national number and the international
 * country code. */
var digitBlockLimit = _common__WEBPACK_IMPORTED_MODULE_1__["MAX_LENGTH_FOR_NSN"] + _common__WEBPACK_IMPORTED_MODULE_1__["MAX_LENGTH_COUNTRY_CODE"];

// Limit on the number of blocks separated by punctuation.
// Uses digitBlockLimit since some formats use spaces to separate each digit.
var blockLimit = Object(_findNumbers_util__WEBPACK_IMPORTED_MODULE_2__["limit"])(0, digitBlockLimit);

/* A punctuation sequence allowing white space. */
var punctuation = '[' + _common__WEBPACK_IMPORTED_MODULE_1__["VALID_PUNCTUATION"] + ']' + punctuationLimit;

// A digits block without punctuation.
var digitSequence = _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["pNd"] + Object(_findNumbers_util__WEBPACK_IMPORTED_MODULE_2__["limit"])(1, digitBlockLimit);
 ...
 * </ul>
 */
var PATTERN = '(?:' + _findNumbers_isValidCandidate__WEBPACK_IMPORTED_MODULE_7__["LEAD_CLASS"] + punctuation + ')' + leadLimit + digitSequence + '(?:' + punctuation + digitSequence + ')' + blockLimit + '(?:' + Object(_common__WEBPACK_IMPORTED_MODULE_1__["create_extension_pattern"])('matching') + ')?';
...
//
var UNWANTED_END_CHAR_PATTERN = new RegExp('[^' + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["_pN"] + _findNumbers_utf_8__WEBPACK_IMPORTED_MODULE_3__["_pL"] + '#]+$');
...
var PhoneNumberMatcher = function () {
  ...
  function PhoneNumberMatcher() {
    ...
    this.leniency = _findNumbers_Leniency__WEBPACK_IMPORTED_MODULE_4__["default"][options.leniency];
  ...
  _createClass(PhoneNumberMatcher, [{
    ...
    value: function find() // (index)
    {
      ...
      while (this.maxTries > 0 && (matches = this.PATTERN.exec(this.text)) !== null) {
        ...
        candidate = Object(_findNumbers_parsePreCandidate__WEBPACK_IMPORTED_MODULE_5__["default"])(candidate);

        if (Object(_findNumbers_isValidPreCandidate__WEBPACK_IMPORTED_MODULE_6__["default"])(candidate, offset, this.text)) {
          var match =
          ...
          if (match) {
            if (this.options.v2) {
              var phoneNumber = new _PhoneNumber__WEBPACK_IMPORTED_MODULE_0__["default"](match.country, match.phone, this.metadata.metadata);
              if (match.ext) {
      ...
      for (var _iterator = INNER_MATCHES, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        ...
        while ((matches = possibleInnerMatch.exec(candidate)) !== null && this.maxTries > 0) {
          if (isFirstMatch) {
            ...
            var _group = Object(_findNumbers_util__WEBPACK_IMPORTED_MODULE_2__["trimAfterFirstMatch"])(UNWANTED_END_CHAR_PATTERN, candidate.slice(0, matches.index));
          ...
          var group = Object(_findNumbers_util__WEBPACK_IMPORTED_MODULE_2__["trimAfterFirstMatch"])(UNWANTED_END_CHAR_PATTERN, matches[1]);
    ...
    value: function parseAndVerify(candidate, offset, text) {
      if (!Object(_findNumbers_isValidCandidate__WEBPACK_IMPORTED_MODULE_7__["default"])(candidate, offset, text, this.options.leniency)) {
        return;
      }

      var number = Object(_parse__WEBPACK_IMPORTED_MODULE_9__["default"])(candidate, {
        extended: true,
...
function extractCountryCallingCode(number, country, metadata) {
	number = Object(_parseIncompletePhoneNumber__WEBPACK_IMPORTED_MODULE_2__["default"])(number);
	...
	if (number[0] !== '+') {
		...
		var numberWithoutIDD = Object(_IDD__WEBPACK_IMPORTED_MODULE_0__["stripIDDPrefix"])(number, country, metadata);
...
function findNumbers(arg_1, arg_2, arg_3, arg_4) {
	var _sort_out_arguments = Object(_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_0__["sort_out_arguments"])(arg_1, arg_2, arg_3, arg_4),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  VALID: function VALID(number, candidate, metadata) {
    if (!Object(_validate__WEBPACK_IMPORTED_MODULE_1__["default"])(number, metadata) || !containsOnlyValidXChars(number, candidate.toString(), metadata)) {
      return false;
    }
  ...
  STRICT_GROUPING: function STRICT_GROUPING(number, candidate, metadata) {
    ...
    if (!Object(_validate__WEBPACK_IMPORTED_MODULE_1__["default"])(number, metadata) || !containsOnlyValidXChars(number, candidateString, metadata) || containsMoreThanOneSlashInNationalNumber(number, candidateString) || !isNationalPrefixPresentIfRequired(number, metadata)) {
      return false;
    }
...
function allNumberGroupsAreExactlyPresent(metadata, number, normalizedCandidate, formattedNumberGroups) {
  ...
  return candidateNumberGroupIndex >= 0 && Object(_util__WEBPACK_IMPORTED_MODULE_3__["endsWith"])(candidateGroups[candidateNumberGroupIndex], formattedNumberGroups[0]);
}
  ...
  for (var i = 0; i < formattedNumberGroups.length; i++) {
    ...
    if (i == 0 && fromIndex < normalizedCandidate.length()) {
      ...
      if (util.getNddPrefixForRegion(region, true) != null && Character.isDigit(normalizedCandidate.charAt(fromIndex))) {
        ...
        var nationalSignificantNumber = util.getNationalSignificantNumber(number);
        return Object(_util__WEBPACK_IMPORTED_MODULE_3__["startsWith"])(normalizedCandidate.slice(fromIndex - formattedNumberGroups[i].length), nationalSignificantNumber);
      }
    }
  }
...
function parseDigits(string) {
  ...
  for (var _iterator2 = string.split(''), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
    ...
    var digit = Object(_common__WEBPACK_IMPORTED_MODULE_2__["parseDigit"])(character);
    if (digit) {
      result += digit;
    }
  }
...
var PUNCTUATION_IN_THE_END_PATTERN = new RegExp('[' + _common__WEBPACK_IMPORTED_MODULE_2__["VALID_PUNCTUATION"] + ']+$');
...
var defaultOptions = {
	...
	switch (format_type) {
		...
		case 'IDD':
			...
			var IDDPrefix = Object(_IDD__WEBPACK_IMPORTED_MODULE_2__["getIDDPrefix"])(options.fromCountry, metadata.metadata);
			if (!IDDPrefix) {
				return;
			}
...
function choose_format_for_number(available_formats, national_number) {
	for (var _iterator = available_formats, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
		...
		if (Object(_common__WEBPACK_IMPORTED_MODULE_0__["matches_entirely"])(national_number, _format.pattern())) {
			return _format;
		}
	}
}
...
function sort_out_arguments(arg_1, arg_2, arg_3, arg_4, arg_5) {
	...
	if (typeof arg_1 === 'string') {
		...
		if (typeof arg_3 === 'string') {
			...
			input = Object(_parse__WEBPACK_IMPORTED_MODULE_1__["default"])(arg_1, { defaultCountry: arg_2, extended: true }, metadata);
		}
		...
		// `format('+78005553535', 'NATIONAL', [options], metadata)`.
				...
				input = Object(_parse__WEBPACK_IMPORTED_MODULE_1__["default"])(arg_1, { extended: true }, metadata);
			}
	}
...
function get_number_type(arg_1, arg_2, arg_3, arg_4) {
	...
	if (!Object(_common__WEBPACK_IMPORTED_MODULE_1__["matches_entirely"])(nationalNumber, metadata.nationalNumberPattern())) {
		return;
	}
...
function is_of_type(nationalNumber, type, metadata) {
	...
	return Object(_common__WEBPACK_IMPORTED_MODULE_1__["matches_entirely"])(nationalNumber, type.pattern());
}
...
function sort_out_arguments(arg_1, arg_2, arg_3, arg_4) {
	...
	return { input: input, options: options, metadata: new _metadata__WEBPACK_IMPORTED_MODULE_2__["default"](metadata) };
}
...
function is_possible_number(national_number, is_international, metadata) {
	switch (Object(_getNumberType__WEBPACK_IMPORTED_MODULE_0__["check_number_length_for_type"])(national_number, undefined, metadata)) {
		case 'IS_POSSIBLE':
			return true;
		// case 'IS_POSSIBLE_LOCAL_ONLY':
...
function isValidNumberForRegion(number, country, _metadata) {
  ...
  var _sort_out_arguments = Object(_getNumberType__WEBPACK_IMPORTED_MODULE_0__["sort_out_arguments"])(number, country, _metadata),
      input = _sort_out_arguments.input,
      metadata = _sort_out_arguments.metadata;

  return input.country === country && Object(_validate__WEBPACK_IMPORTED_MODULE_1__["default"])(input, metadata.metadata);
}
...
var default_options = {
	...
	//
	if (nationalNumber.length > _common__WEBPACK_IMPORTED_MODULE_0__["MAX_LENGTH_FOR_NSN"]) {
		if (options.v2) {
	...
	if (options.v2) {
		var phoneNumber = new _PhoneNumber__WEBPACK_IMPORTED_MODULE_7__["default"](countryCallingCode, nationalNumber, metadata.metadata);
	...
	var valid = country && Object(_common__WEBPACK_IMPORTED_MODULE_0__["matches_entirely"])(nationalNumber, metadata.nationalNumberPattern()) ? true : false;
	...
	return {
		...
		valid: valid,
		possible: valid ? true : options.extended === true && metadata.possibleLengths() && Object(_isPossibleNumber__WEBPACK_IMPORTED_MODULE_5__["is_possible_number"])(nationalNumber, countryCallingCode !== undefined, metadata),
...
function _find_country_code(possible_countries, national_phone_number, metadata) {
	...
	for (var _iterator = possible_countries, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
		...
		else if (Object(_getNumberType__WEBPACK_IMPORTED_MODULE_4__["default"])({ phone: national_phone_number, country: country }, metadata.metadata)) {
				return country;
			}
	}
}
...
function sort_out_arguments(arg_1, arg_2, arg_3, arg_4) {
	...
	return { text: text, options: options, metadata: new _metadata__WEBPACK_IMPORTED_MODULE_2__["default"](metadata) };
}
...
function parse_input(text, v2) {
	...
	if (text && text.indexOf('tel:') === 0) {
		return Object(_RFC3966__WEBPACK_IMPORTED_MODULE_6__["parseRFC3966"])(text);
	}
...
function parse_phone_number(formatted_phone_number, default_country, metadata) {
	var _extractCountryCallin = Object(_common__WEBPACK_IMPORTED_MODULE_0__["extractCountryCallingCode"])(formatted_phone_number, default_country, metadata.metadata),
	    countryCallingCode = _extractCountryCallin.countryCallingCode,
	    number = _extractCountryCallin.number;
	...
	if (countryCallingCode) {
		...
		countryCallingCode = Object(_getCountryCallingCode__WEBPACK_IMPORTED_MODULE_3__["default"])(default_country, metadata.metadata);
	} else return {};
...
function parse_national_number(number, metadata) {
	var national_number = Object(_parseIncompletePhoneNumber__WEBPACK_IMPORTED_MODULE_1__["default"])(number);
	...
	if (metadata.possibleLengths()) {
		...
		// Otherwise, we don't do the stripping, since the original number could be
		// a valid short number.
		switch (Object(_getNumberType__WEBPACK_IMPORTED_MODULE_4__["check_number_length_for_type"])(potential_national_number, undefined, metadata)) {
			case 'TOO_SHORT':
			// case 'IS_POSSIBLE_LOCAL_ONLY':
			case 'INVALID_LENGTH':
				break;
...
function parsePhoneNumberCharacter(character, value) {
	...
	// Allow digits.
	return Object(_common__WEBPACK_IMPORTED_MODULE_0__["parseDigit"])(character);
}
...
function parsePhoneNumber(text, defaultCountry, metadata) {
	...
	return Object(_parse__WEBPACK_IMPORTED_MODULE_1__["default"])(text, { defaultCountry: defaultCountry, v2: true }, metadata);
}
...
function isValidNumber(arg_1, arg_2, arg_3, arg_4) {
  ...
  if (metadata.hasTypes()) {
    return Object(_getNumberType__WEBPACK_IMPORTED_MODULE_0__["default"])(input, options, metadata.metadata) !== undefined;
  }

  // If there are no type regexps for this country in metadata then use
  // `nationalNumberPattern` as a "better than nothing" replacement.
  var national_number = options.v2 ? input.nationalNumber : input.phone;
  return Object(_common__WEBPACK_IMPORTED_MODULE_1__["matches_entirely"])(national_number, metadata.nationalNumberPattern());
}
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isValidNumberCustom", function() { return _es6_validate__WEBPACK_IMPORTED_MODULE_7__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "findPhoneNumbersCustom", function() { return _es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "searchPhoneNumbersCustom", function() { return _es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["searchPhoneNumbers"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PhoneNumberSearchCustom", function() { return _es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["PhoneNumberSearch"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getNumberTypeCustom", function() { return _es6_getNumberType__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getCountryCallingCodeCustom", function() { return _es6_getCountryCallingCode__WEBPACK_IMPORTED_MODULE_14__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AsYouTypeCustom", function() { return _es6_AsYouType__WEBPACK_IMPORTED_MODULE_13__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DIGIT_PLACEHOLDER", function() { return _es6_AsYouType__WEBPACK_IMPORTED_MODULE_13__["DIGIT_PLACEHOLDER"]; });
...
function getExampleNumber()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_getExampleNumber__WEBPACK_IMPORTED_MODULE_5__["default"].apply(this, parameters)
}
...
function isPossibleNumber()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_isPossibleNumber__WEBPACK_IMPORTED_MODULE_6__["default"].apply(this, parameters)
}
...
function isValidNumber()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_validate__WEBPACK_IMPORTED_MODULE_7__["default"].apply(this, parameters)
}
...
function isValidNumberForRegion()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_isValidNumberForRegion__WEBPACK_IMPORTED_MODULE_8__["default"].apply(this, parameters)
}
...
function findPhoneNumbers()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["default"].apply(this, parameters)
}
...
function searchPhoneNumbers()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["searchPhoneNumbers"].apply(this, parameters)
}

// Deprecated.
function PhoneNumberSearch(text, options)
{
	_es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["PhoneNumberSearch"].call(this, text, options, _metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
}

// Deprecated.
PhoneNumberSearch.prototype = Object.create(_es6_findPhoneNumbers__WEBPACK_IMPORTED_MODULE_9__["PhoneNumberSearch"].prototype, {})
...
function findNumbers()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_findNumbers__WEBPACK_IMPORTED_MODULE_10__["default"].apply(this, parameters)
}
...
function searchNumbers()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_searchNumbers__WEBPACK_IMPORTED_MODULE_11__["default"].apply(this, parameters)
}

function PhoneNumberMatcher(text, options)
{
	_es6_PhoneNumberMatcher__WEBPACK_IMPORTED_MODULE_12__["default"].call(this, text, options, _metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
}

PhoneNumberMatcher.prototype = Object.create(_es6_PhoneNumberMatcher__WEBPACK_IMPORTED_MODULE_12__["default"].prototype, {})
PhoneNumberMatcher.prototype.constructor = PhoneNumberMatcher

function AsYouType(country)
{
	_es6_AsYouType__WEBPACK_IMPORTED_MODULE_13__["default"].call(this, country, _metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
}

AsYouType.prototype = Object.create(_es6_AsYouType__WEBPACK_IMPORTED_MODULE_13__["default"].prototype, {})
...
function getExtPrefix()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_metadata__WEBPACK_IMPORTED_MODULE_15__["getExtPrefix"].apply(this, parameters)
}
...
function parseRFC3966()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_RFC3966__WEBPACK_IMPORTED_MODULE_16__["parseRFC3966"].apply(this, parameters)
}
...
function formatRFC3966()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_RFC3966__WEBPACK_IMPORTED_MODULE_16__["formatRFC3966"].apply(this, parameters)
}
...
function formatIncompletePhoneNumber()
{
	var parameters = Array.prototype.slice.call(arguments)
	parameters.push(_metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
	return _es6_formatIncompletePhoneNumber__WEBPACK_IMPORTED_MODULE_17__["default"].apply(this, parameters)
}
...
{
	return Object(_es6_getCountryCallingCode__WEBPACK_IMPORTED_MODULE_14__["default"])(country, _metadata_min_json__WEBPACK_IMPORTED_MODULE_0__)
}
...
{
	return Object(_es6_getCountryCallingCode__WEBPACK_IMPORTED_MODULE_14__["default"])(country, metadata)
}
...
//# sourceMappingURL=vendors~libphonenumber-js-chunk-d80fe6.js.map
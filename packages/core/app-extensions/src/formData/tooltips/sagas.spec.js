      ...
      describe('sagas', () => {
        describe('main saga', () => {
          test('should fork sagas', () => {
            ...
            saga.next().all([takeEvery(tooltipActions.LOAD_TOOLTIP, sagas.loadToolTip)])
          })
        })
        ...
        describe('loadToolTip saga', () => {
          test('should load tooltip if not yet loaded', () => {
            ...
            return expectSaga(sagas.loadToolTip, tooltipActions.loadTooltip(entity, id))
              .provide([
          ...
          test('should not load tooltip if already loaded', () => {
            ...
            return expectSaga(sagas.loadToolTip, tooltipActions.loadTooltip(entity, id))
              .provide([[select(sagas.tooltipSelector, entity, id), tooltip]])

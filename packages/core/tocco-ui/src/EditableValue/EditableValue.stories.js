...
export const Number = args => {
  ...
  return <EditableValue type="number" value={value} events={{onChange: setValue}} {...args} />
}
...
export const Phone = () => {
  ...
  return <EditableValue type="phone" value={value} events={{onChange: setValue}} />
}
...
export const String = () => {
  ...
  return <EditableValue type="string" value={value} events={{onChange: setValue}} />
}

export const Text = () => {
  const [value, setValue] = useState('This is the first line.\nTo be continued...')
  return <EditableValue type="text" value={value} events={{onChange: setValue}} />
}

export const Time = () => {
  const [value, setValue] = useState('18:30')
  return <EditableValue type="time" value={value} events={{onChange: setValue}} />
}

export const Url = () => {
  const [value, setValue] = useState('http://www.tooco.ch')
  return <EditableValue type="url" value={value} events={{onChange: setValue}} />
}

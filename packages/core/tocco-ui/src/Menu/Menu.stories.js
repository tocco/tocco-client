...
export const Basic = args => <ButtonMenu {...args}>{getMenuItems()}</ButtonMenu>

export const ButtonMenuDefault = args => <ButtonMenu {...args}>{getMenuItems()}</ButtonMenu>

ButtonMenuDefault.argTypes = {
  onClick: {action: 'onClick'}
}

export const Ball = args => <BallMenu {...args}>{getMenuItems()}</BallMenu>
...
const getMenuItems = () => (
  <MenuItem>
    <MenuItem title={'1 title'} onClick={action('1 Clicked')}>
      1
    </MenuItem>
    <MenuItem title={'2 title'} onClick={action('clicked 2')}>
      2
    </MenuItem>
    <MenuItem isGroup={true} onClick={action('clicked 3')}>
      3<MenuItem onClick={action('clicked 3.1')}>3.1</MenuItem>
      <MenuItem disabled title="disabled!" onClick={action('clicked 3.2')}>
        3.2 (disabled)
      </MenuItem>
      <MenuItem>
        3.3 (No onclick)

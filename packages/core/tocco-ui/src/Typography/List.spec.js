    ...
    describe('List', () => {
      describe('Dd', () => {
        test('should have one defaultProps', () => {
          const wrapper = shallow(<Dd>Lorem Ipsum</Dd>)
      ...
      describe('Dl', () => {
        test('should display text', () => {
          const wrapper = mount(<Dl>Lorem ipsum</Dl>)
      ...
      describe('Dt', () => {
        test('should have one defaultProps', () => {
          const wrapper = shallow(<Dt>Lorem Ipsum</Dt>)
          const {breakWords, title} = wrapper.props()
          expect(breakWords).to.be.true
          expect(title).to.be.undefined
        })
      ...
      describe('Li', () => {
        test('should display text', () => {
          const wrapper = mount(<Li>Lorem ipsum</Li>)
      ...
      describe('Ol', () => {
        test('should display text', () => {
          const wrapper = mount(<Ol>Lorem ipsum</Ol>)
      ...
      describe('Ul', () => {
        test('should display text', () => {
          const wrapper = mount(<Ul as="ul">Lorem ipsum</Ul>)

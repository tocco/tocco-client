...
export const Boolean = args => <FormattedValue {...args} />

Boolean.argTypes = {value: {type: 'boolean', defaultValue: true}, type: {defaultValue: 'boolean'}}

export const DateTime = args => <FormattedValue {...args} />
...
export const Description = ({mode, title, ...args}) => <FormattedValue {...args} options={{mode, title}} />
...
export const Document = args => <FormattedValue {...args} />
...
export const DocumentCompact = args => <FormattedValue {...args} />
...
export const Duration = args => <FormattedValue {...args} />
...
export const MultiSelect = args => <FormattedValue {...args} />
...
export const Number = args => <FormattedValue {...args} />

Number.argTypes = {value: {type: 'number', defaultValue: 876600.01}, type: {defaultValue: 'number'}}

export const Percent = args => <FormattedValue {...args} />

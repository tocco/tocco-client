...
describe('tocco-ui', () => {
  ...
  describe('Pagination', () => {
    test('should disable first and second button when on first page', () => {
      const wrapper = intlEnzyme.mountWithIntl(<Pagination {...basicTestProps} currentPage={1} />)
    ...
    test('should disable last and second-last button when on last page', () => {
      ...
      const wrapper = intlEnzyme.mountWithIntl(<Pagination {...basicTestProps} currentPage={lastPage} />)
    ...
    test('should call callback with correct new page', () => {
      ...
      const wrapper = intlEnzyme.mountWithIntl(<Pagination {...basicTestProps} onPageChange={onChangeSpy} />)
    ...
    test('should show correct page information', () => {
      ...
      const to = 25
      const total = 50
      const wrapper = intlEnzyme.mountWithIntl(<Pagination currentPage={1} recordsPerPage={25} totalCount={50} />)
    ...
    test('should handle less entries than page size', () => {
      ...
      const to = 10
      const total = 10
      const wrapper = intlEnzyme.mountWithIntl(<Pagination currentPage={1} recordsPerPage={25} totalCount={10} />)
      const message = wrapper.find(FormattedMessage).first()
      expect(message.prop('values')).to.deep.equal({start, to, total})
    })

    test('should handle no entries', () => {
      const wrapper = intlEnzyme.mountWithIntl(<Pagination currentPage={1} recordsPerPage={25} totalCount={0} />)

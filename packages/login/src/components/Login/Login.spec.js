  ...
  describe('components', () => {
    describe('Login', () => {
      test('should render LoginFormContainer as default', () => {
        const withoutTitle = shallow(<Login initialize={() => undefined} />)
        ...
        const withTitle = shallow(<Login showTitle initialize={() => undefined} />)
      ...
      test('should render PasswordUpdateContainer', () => {
        const withoutTitle = shallow(<Login currentPage={Pages.PASSWORD_UPDATE} initialize={() => undefined} />)
        ...
        const withTitle = shallow(<Login showTitle currentPage={Pages.PASSWORD_UPDATE} initialize={() => undefined} />)
      ...
      test('should render PasswordRequestContainer', () => {
        const withoutTitle = shallow(<Login currentPage={Pages.PASSWORD_REQUEST} initialize={() => undefined} />)
        ...
        const withTitle = shallow(<Login showTitle currentPage={Pages.PASSWORD_REQUEST} initialize={() => undefined} />)
      ...
      test('should render TwoStepLoginContainer', () => {
        const withoutTitle = shallow(<Login currentPage={Pages.TWOSTEPLOGIN} initialize={() => undefined} />)
        ...
        const withTitle = shallow(<Login showTitle currentPage={Pages.TWOSTEPLOGIN} initialize={() => undefined} />)

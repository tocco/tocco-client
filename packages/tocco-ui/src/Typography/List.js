...
const Dd = props => (
  <StyledDd breakWords={props.breakWords} title={props.breakWords ? undefined : getTextOfChildren(props.children)}>
    {props.children}
  </StyledDd>
)
...
const Dt = props => (
  <StyledDt breakWords={props.breakWords} title={props.breakWords ? undefined : getTextOfChildren(props.children)}>
    {props.children}
  </StyledDt>
)
...
Dd.defaultProps = Dt.defaultProps = {
  breakWords: true
}

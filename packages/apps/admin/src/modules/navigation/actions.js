...
export const SET_SHORTCUT_MENU_TAB = 'navigation/SET_SHORTCUT_MENU_TAB'
...
export const toggleShortcutMenu = activeMenuTab => ({
...
export const setShortcutMenu = menuTab => ({
  type: SET_SHORTCUT_MENU_TAB,
  payload: {
    menuTab
  }
})

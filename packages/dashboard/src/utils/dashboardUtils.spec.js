  ...
  describe('utils', () => {
    describe('dashboardUtils', () => {
      ...
      describe('moveDraggedToDropped', () => {
        test('should move after another item', () => {
          const draggingId = 1
          const dragOverId = 2
        ...
        test('should move before another item', () => {
          const draggingId = 3
          const dragOverId = 1
        ...
        test('should move to another column', () => {
          const draggingId = 2
          const dragOverId = 4
          const position = dragAndDrop.DropPosition.Bottom
          const boxes = [
        ...
        test('should be able to handle items at same position', () => {
          const draggingId = 3
          const dragOverId = 4
          const position = dragAndDrop.DropPosition.Bottom
          const boxes = [
      ...
      describe('appendDraggedAsLastItemToDropped', () => {
        test('should append item to another emtpy column', () => {
          const draggingId = 1
          const dragOverId = 1
          const boxes = [
            {id: 1, col: 0, row: 0},
        ...
        test('should append item at the end to another column', () => {
          const draggingId = 1
          const dragOverId = 1
          const boxes = [
            {id: 1, col: 0, row: 0},
        ...
        test('should be able to handles items at same position', () => {
          const draggingId = 1
          const dragOverId = 1
          const boxes = [
            {id: 1, col: 0, row: 0},
